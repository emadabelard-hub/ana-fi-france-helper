...
const UNIT_GUIDE = [
  ...
  },
  {
    ...
    name_fr: 'Kilomètre',
    name_ar: 'كيلومتر',
    description_fr: 'Pour les déplacements : Taxi, Uber, livraison.',
    description_ar: 'للتنقلات: تاكسي، أوبر، توصيل.',
    bgColor: 'bg-blue-100 dark:bg-blue-950/40',
    borderColor: 'border-blue-200 dark:border-blue-800',
    badgeColor: 'bg-blue-800 text-white',
    selectedRing: 'ring-blue-700',
  },
  {
    code: 'Nuit',
    name_fr: 'Nuit',
    name_ar: 'ليلة',
    description_fr: 'Hébergement, hôtels, location courte durée.',
    description_ar: 'للإقامة والفنادق والإيجار القصير.',
  ...
  },
  {
    ...
    name_fr: 'Repas',
    name_ar: 'وجبة',
    description_fr: 'Pour la restauration : Tajines, traiteur, plats.',
    description_ar: 'للطعام: طواجن، ترايتور، أكل.',
  ...
  },
  {
    ...
    name_fr: 'Séance',
    name_ar: 'جلسة',
    description_fr: 'Pour le coaching : Cours, formations, consultations.',
    description_ar: 'للتدريب: كوتش، دروس، استشارة.',
  ...
  },
  {
    ...
    name_fr: 'Mètre Cube',
    name_ar: 'متر مكعب',
    description_fr: 'Pour remblai et terre : Gravats, sable, gravier.',
    description_ar: 'للردم والتراب: نقل ركام، رمل، حصى.',
    bgColor: 'bg-amber-100 dark:bg-amber-950/40',
    borderColor: 'border-amber-200 dark:border-amber-800',
    badgeColor: 'bg-amber-800 text-white',
    selectedRing: 'ring-amber-700',
  },
  {
    code: 'Tonne',
    name_fr: 'Tonne',
    name_ar: 'طن',
    description_fr: 'Transport de matériaux lourds : Gravats, fer, béton.',
    description_ar: 'لنقل المواد الثقيلة: ركام، حديد، خرسانة.',
