...
const valueProps = [
  {
    ...
    text: 'ورقك هو حياتك. البرنامج بيقوم بالتحليل آلياً في سرية تامة، ومحدش بيشوفه غيرك.',
  },
  {
    icon: '🔍',
    title: 'تحليل دقيق للموقف',
    text: 'مش مجرد ترجمة عادية للكلام. إحنا بنترجم الموقف كله، وبنحلل حالتك بصورة علمية عشان تفهم وتعرف تتصرف صح.',
  },
  {
    icon: '👑',
  ...
  {
    icon: '⚡',
    title: 'ما عليك إلا تكتب واحنا نخلص',
    text: 'هنقولك تعمل إيه بالظبط عشان تنجز. ولو الحل محتاج خطاب رسمي أو إيميل بالفرنساوي، إحنا اللي هنعملهولك.',
  },
];
