...
Quand tu as toutes les infos, dis "✅ جاهز لتوليد الدوفي" et résume les paramètres.`;
    ...
    if (action === "generate_items") {
      ...
      const systemPrompt = `Tu es un Expert BTP français, métreur et économiste de la construction.
...
⛔ MAXIMUM 7 à 8 lignes de devis. Pas plus.
...
⛔ RÈGLE TRANSLITÉRATION pour designation_ar:
Parquet→باركيه, Primaire→بريمير, Ragréage→راغرياج, Sous-couche→سوكوش, Enduit→أندوي, Peinture→بنتيرة, Carrelage→كارلاج, Ponçage→بونساج, Décapage→ديكاباج, Nettoyage→نيتواياج, Chantier→شانتي
