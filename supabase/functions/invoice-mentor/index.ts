...
serve(async (req) => {
  ...
  try {
    ...
    // Handle translation action (Arabic to French - short label)
    ...
    // Handle BTP reformulation (Arabic/Darija to full professional French BTP description)
    if (body.action === 'reformulate_btp') {
