      ...
      <main className="px-4 flex flex-col justify-between pb-20" style={{ minHeight: 'calc(100vh - 90px)' }}>
        ...
        <div className="flex flex-col gap-3 mt-4">
          ...
          <button
            ...
            className="w-full bg-car300 border border-[hsl(271,76%,53%)]/20 shadow-[0_6px_24px_-6px_hsl(271_76%_40%/0.3)] hover:d rounded-3xl flex items-center gap-4 p-4 active:scale-[0.98] transition-all duration-300 border border-[hsl(271,76%,53%)]/20 shadow-[0_6px_24px_-6px_hsl(271_76%_40%/0.3)] hover:shadow-[0_14px_36px_-6px_hsl(271_76%_40%/0.45)] hover:-translate-y-1 animate-fade-ins-center justify-center" style={{ background: 'linear-gradient(135deg, #8A2BE2, #6A1FB0)' }}>
