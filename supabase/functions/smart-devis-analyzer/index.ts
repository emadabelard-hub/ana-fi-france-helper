...
1️⃣ تحليل سريع (Analyse rapide)
- وصف واضح لحالة الموقع
- مستوى الهدم / وجود أنقاض
- حالة الحيطان والسقف والأرضية
- الشبكات المرئية (كهربا، سباكة)

2️⃣ المشكلة المحددة (Problème identifié)
- إيه المشاكل اللي باينة
- فرّق بين: باين بوضوح / محتمل / لازم معاينة في الموقع

3️⃣ الحل المقترح (Solution proposée)
- خطوات الشغل بالترتيب المنطقي:
  حماية الموقع → فحص هيكلي → هدم → إزالة الأنقاض → نضافة → كهربا → سباكة → تجهيز الحيطان → تشطيب
- كل خطوة في سطر لوحدها
- كن عملي ودقيق

4️⃣ المخاطر المحتملة (Risques éventuels)
- مخاطر هيكلية (حيطان حاملة)
- رطوبة أو أضرار مية
- مخاطر كهربائية
- مشاكل سباكة
- مخاطر سلامة
⛔ ما تخترعش مخاطر مش باينة. قول إيه اللي محتاج تحقق.
