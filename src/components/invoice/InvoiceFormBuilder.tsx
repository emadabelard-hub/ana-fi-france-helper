              ...
              >
                ...
                <div className="sm:hidden flex justify-end">
                  {item.total > 0 ? (
                    ...
                    <span className={cn("text-[11px] font-bold <span className={cn("text-[11px] font-bold bg-sky-300 text-black px-3 py-1.5 rounded cursor-pointer", isRTL && "font-cairo")}> rounded cursor-pointer", isRTL && "font-cairo")}>
