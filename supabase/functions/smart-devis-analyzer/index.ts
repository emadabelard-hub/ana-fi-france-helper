...
- Utilise la translitération phonétique du français en arabe, PAS la traduction dictionnaire.
- Parquet→باركيه, Plinthes→بلانت, Primaire→بريمير, Ragréage→راغرياج, Sous-couche→سوكوش, Enduit→أندوي, Peinture→بانتيرة, Carrelage→كارلاج, Faïence→فايونس, Ponçage→بونساج, Démontage→ديمونتاج, Nettoyage→نيتواياج, Fourniture→فورنيتير
...
- designation_ar = TRANSLITÉRATION phonétique (ex: "فورنيتير و بوز باركيه ستراتيفيي")
